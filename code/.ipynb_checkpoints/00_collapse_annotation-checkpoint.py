# This pipeline requires gene-level expression data.
# A collapsed reference GTF can be generated for this purpose 
# using the collapse_annotation.py script available in the gene model directory. 
